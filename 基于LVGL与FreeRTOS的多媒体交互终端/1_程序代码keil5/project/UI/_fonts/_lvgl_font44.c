...
static uint8_t *__user_font_getdata(int offset, int size){
   ...
   norflash_read_data(__g_font_buf, fontInfo[FONT_LVGL_FONT44].addr + offset, size);
    return __g_font_buf;
}
...
//YaHei Consolas Hybrid,YaHei Consolas Hybrid Regular,24
//字模高度：0
//XBF字体,外部bin文件
const lv_font_t _lvgl_font44 = {
