...
// 1: SDRAM (外部)
static __align(64) uint8_t mem1_block_base[MEM1_MAX_SIZE] __attribute__((at(SYS_SRAMEX_MALLOC_START_ADDR)));
...
static uint32_t mem1_table_base[MEM1_BLOCK_NUM] __attribute__((at(SYS_SRAMEX_MALLOC_START_ADDR + MEM1_MAX_SIZE))); 
