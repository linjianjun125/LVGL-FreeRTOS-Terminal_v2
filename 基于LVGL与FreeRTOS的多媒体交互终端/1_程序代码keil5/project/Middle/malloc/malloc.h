...
-------------------------------------------------------------*/
#define MEM0_MAX_SIZE            (200 * 1024)                        // 0-内部 AXI 内存大小
#define MEM1_MAX_SIZE            (2 * 1024 * 1024)                   // 1-外部 SDRAM 内存大小
#define MEM2_MAX_SIZE            (240 * 1024)                        // 2-内部 SRAM1/SRAM2 内存大小
#define MEM3_MAX_SIZE            (60 * 1024)                         // 3-内部 SRAM4 内存大小
#define MEM4_MAX_SIZE            (120 * 1024)                         // 4-内部 DTCM 内存大小
#define MEM5_MAX_SIZE            (60 * 1024)                         // 5-内部 ITCM 内存大小
