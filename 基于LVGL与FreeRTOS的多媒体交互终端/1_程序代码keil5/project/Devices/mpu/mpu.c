...
// 修改为：
// 如果是保护 SDRAM 区域 (Region 6)，设置 TEX=1 (Level 1)
if (rnum == 6) {
    tempreg |= 1 << 19; /* 设置类型扩展域为 level1 */
} else {
    tempreg |= 0 << 19; /* 其他区域保持 level0 */
}
...
void mpu_memory_protection(void)
{
	...
	/* 这样配置在 TEX=0 时代表 Write-Through 模式 */
	//mpu_set_protection(0XC0000000, 32 * 1024 * 1024, 6, 0, MPU_REGION_FULL_ACCESS, 0, 1, 0);
