...
void norflash_erase_data(uint32_t addr, uint32_t datalen);				// 擦除flash
void norflash_read_data(uint8_t *pbuf, uint32_t addr, uint16_t datalen); // 读取flash
void norflash_write_data(uint8_t *pbuf, uint32_t addr, uint16_t datalen);// 写入flash
